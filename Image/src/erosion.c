...
static void * erosionH(IMAGE *pimgsrc, IMAGE *pimgdst, IMAGE *pimgwrk);
static void * erosionV(IMAGE *pimgsrc, IMAGE *pimgdst, IMAGE *pimgwrk);
static void * erosionBlock(IMAGE *pimgsrc, IMAGE *pimgdst, IMAGE *pimgwrk);
...
EXPORT_C int IMAGE_ErosionH(IMAGE * const pimgsrc, IMAGE * const pimgdst)
{
	...
	erosionH(pimgsrc, pimgdst, &imgwrk);
...
EXPORT_C int IMAGE_ErosionV(IMAGE * const pimgsrc, IMAGE * const pimgdst)
{
	...
	erosionV(pimgsrc, pimgdst, &imgwrk);
...
EXPORT_C int IMAGE_ErosionBlock(IMAGE * const pimgsrc, IMAGE * const pimgdst)
{
	...
	erosionBlock(pimgsrc, pimgdst, &imgwrk);
