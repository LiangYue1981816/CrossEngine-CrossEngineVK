...
void CreateMesh(void)
{
	...
	Mesh.ptrGraphics = GfxDevice()->NewPipelineGraphics(1);
	...
	Mesh.ptrVertexBuffer->Create(vertexBuffer.size() * sizeof(Vertex), vertexBuffer.data(), FALSE, CrossEngine::VERTEX_ATTRIBUTE_POSITION | CrossEngine::VERTEX_ATTRIBUTE_UV0);
...
void CreateScreen(void)
{
	...
	Screen.ptrGraphics = GfxDevice()->NewPipelineGraphics(1);
...
void Render(void)
{
	...
	Mesh.ptrUniformBuffer->SetData(0, sizeof(glm::mat4), &mtxViewModelProjection);
