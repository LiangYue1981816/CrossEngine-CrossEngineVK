...
#include <EASTL/numeric_limits.h>
	...
	namespace eastl
	{
		namespace Internal
		{
			// For this platformc/compiler combination we fall back to using eastl::numeric_limits,
			...
			// To do: Initialize these values via a means that doesn't depend on eastl::numeric_limits.

			EASTL_API float       gFloatInfinity      = eastl::numeric_limits<float>::infinity();
			EASTL_API float       gFloatNaN           = eastl::numeric_limits<float>::quiet_NaN();
			EASTL_API float       gFloatSNaN          = eastl::numeric_limits<float>::signaling_NaN();
			EASTL_API float       gFloatDenorm        = eastl::numeric_limits<float>::denorm_min();

			EASTL_API double      gDoubleInfinity     = eastl::numeric_limits<double>::infinity();
			EASTL_API double      gDoubleNaN          = eastl::numeric_limits<double>::quiet_NaN();
			EASTL_API double      gDoubleSNaN         = eastl::numeric_limits<double>::signaling_NaN();
			EASTL_API double      gDoubleDenorm       = eastl::numeric_limits<double>::denorm_min();

			EASTL_API long double gLongDoubleInfinity = eastl::numeric_limits<long double>::infinity();
			EASTL_API long double gLongDoubleNaN      = eastl::numeric_limits<long double>::quiet_NaN();
			EASTL_API long double gLongDoubleSNaN     = eastl::numeric_limits<long double>::signaling_NaN();
			EASTL_API long double gLongDoubleDenorm   = eastl::numeric_limits<long double>::denorm_min();
		}
   } 
#endif
